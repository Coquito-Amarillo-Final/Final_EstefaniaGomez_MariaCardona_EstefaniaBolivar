...
### 2. [models.py](https://github.com/Coquito-Amarillo-Final/Final_EstefaniaGomez_MariaCardona_EstefaniaBolivar/blob/MainBranch/api/models.py)
...
### 3. [requirements.txt](https://github.com/Coquito-Amarillo-Final/Final_EstefaniaGomez_MariaCardona_EstefaniaBolivar/blob/MainBranch/api/requirements.txt)
